<div>
    ...
    <section class="bg-white border-b py-8">
        <div class="container max-w-5xl mx-auto m-8">
            <h1 class="w-full my-2 sm:text-3xl text-5xl font-bold leading-tight text-center text-gray-800">
                Visi & Misi
            </h1>
            ...
            <div class="flex flex-wrap">
                <div class="w-5/6 sm:w-1/2 p-6">
                    <h3 class="text-lg text-gray-800 font-bold leading-none mb-3">
    ...
    <section class="bg-gray-100 py-8">
        <div class="container mx-auto px-2 pt-4 pb-12 text-gray-800">
            <h1 class="w-full my-2 text-5xl sm:text-3xl font-bold leading-tight text-center text-gray-800">
            ...
            <div class="flex flex-col sm:flex-row justify-center pt-12 my-12 sm:my-4">
                <div class="flex flex-col w-5/6 lg:w-1/4 mx-auto lg:mx-0 rounded-none lg:rounded-l-lg bg-white mt-4">
                    <div class="flex-1 bg-white text-gray-600 rounded-t rounded-b-none overflow-hidden shadow">
                        <div class="p-8 text-lg font-bold text-center border-b-4">
                            Wakil Kepala Sekolah
                        </div>
                        <ul class=" flex flex-col w-full items-center text-center text-sm">
                            <li class="border-b py-4"><img src="http://picsum.photos/seed/30/150" alt="" class="rounded-full"></li>
                            <li class="border-b py-4 px-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptatibus, quisquam?</li>
                            <span class="m-4 font-bold">nama Wakil Kepala Sekolah</span>
                        </ul>
                    </div>
                </div>
                <div class="flex flex-col w-5/6 lg:w-1/3 mx-auto lg:mx-0 rounded-lg bg-white mt-4 sm:-mt-6 shadow-lg z-10">
                    <div class="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
                        <div class="w-full p-8 text-2xl font-bold text-center">Kepala Sekolah</div>
                        <div class="h-1 w-full gradient my-0 py-0 rounded-t"></div>
                        <ul class=" flex flex-col w-full items-center text-center text-sm">
                            <li class="border-b py-4"><img src="http://picsum.photos/seed/30/150" alt="" class="rounded-full"></li>
                            <li class="border-b py-4 px-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptatibus, quisquam?</li>
                            <span class="m-4 font-bold">nama kepala sekolah</span>
                        </ul>
                    </div>
                </div>
                <div class="flex flex-col w-5/6 lg:w-1/4 mx-auto lg:mx-0 rounded-none lg:rounded-l-lg bg-white mt-4">
                    <div class="flex-1 bg-white text-gray-600 rounded-t rounded-b-none overflow-hidden shadow">
                        <div class="p-8 text-md font-bold text-center border-b-4">
                            Staf Tata Usaha
                        </div>
                        <ul class=" flex flex-col w-full items-center text-center text-sm">
                            <li class="border-b py-4"><img src="http://picsum.photos/seed/30/150" alt="" class="rounded-full"></li>
                            <li class="border-b py-4 px-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptatibus, quisquam?</li>
                            <span class="m-4 font-bold">nama Staf Tata Usaha</span>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <section class="container mx-auto text-center py-6 mb-12">
        <h1 class="w-full my-2 text-4xl font-bold leading-tight text-center text-white">
            Daftar PPDB Online sekarang juga..
        </h1>
        <div class="w-full mb-4">
